...
const double GRAV = .00006; //gravitational constant
...
int main(int argc, char** argv)
{
	...
	else
	{
		...
		else
		{
			...
			//Orbitting:
			circles.push_back(PhysicsCircle(400, 400, 30));
			circles.push_back(PhysicsCircle(475, 400, 2));
			circles.back().m_dy = -.2;
			while (!quit)
			{
				...
				for (PhysicsCircle& c : circles)
				{
					c.render(g_renderer, camerax, cameray);
				}
